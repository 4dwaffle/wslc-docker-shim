...
internal static class DeleteVolumeEndpoint
{
    public static void Map(IEndpointRouteBuilder endpoints)
    {
        endpoints.MapDelete("/volumes/{id}", HandleAsync);
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        await backend.DeleteResourceAsync(DockerResourceKind.Volume, id, cancellationToken);
